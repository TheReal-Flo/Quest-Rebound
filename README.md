...
Since QuestCraft changed to OpenXR a few months ago, Questbind became unsupported.
...
This mod is still in a very early stage. While developing the first build, I recognized quite a few performance problems on my Pico 4, which I haven't seen without the mod before. Just saying.
...
Most of the performance issues and crashes should be fixed, but there might be other issues I'm not aware of. If any issues occur, try removing the mod or delete the configurations.
